package com.brijesh.microservices.currencyconversionservice.beans;
...
public class CurrencyConversionBean {
    ...
    public CurrencyConversionBean(Long id, String from, String to, BigDecimal conversionMultiple, BigDecimal quantity, BigDecimal totalCalulatedAmount, int port) {
        this.id = id;
        this.from = from;
        this.to = to;
